...
#                        defaults; MEM_FRACTION_STATIC→0.6 for qwen paras). Overlap
#                        stays enabled (drain-on-switch in SchedulerParasMixin).
...
#                        UMM init; on static avoids SWARadixCache drift).
