#!/bin/bash
# bench_one_batch — Qwen3-235B-A22B-Instruct-2507, TP/TP (TP attention + TP experts), H200.
# --batch-size is the global batch (no DP attention).
#
...
RESULT_FILE=${RESULT_FILE:-/tmp/qwen235b_tp_tp.jsonl}
RUN_NAME=${RUN_NAME:-tp_tp}
