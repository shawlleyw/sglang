...
if [[ "$DRY_RUN" == "1" ]]; then
    ...
    echo "  ENABLE_PARAS=$ENABLE_PARAS NUM_GPUS=$NUM_GPUS ENABLE_CUDA_GRAPH=1 CUDA_GRAPH_MAX_BS=512 MAX_RUNNING_REQUESTS=512 MEM_FRACTION_STATIC=$MEM_FRACTION_STATIC \\"
