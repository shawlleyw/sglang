#!/usr/bin/bash
# evallib/server.sh — SGLang server lifecycle helpers for Sphere eval
...
#   SERVER_PORT, SERVER_READY_TIMEOUT, DIST_TIMEOUT
...
_build_server_cmd() {
    ...
    cmd+=" && export NCCL_IB_GID_INDEX=${NCCL_IB_GID_INDEX}"
