#!/bin/bash
# DP-attention EP16 head (rank 0) — mooncake-nccl, WITH recorder
# Cluster: 8 nodes × 2 L40S = 16 GPUs (sgpu0 head + sgpu2/3/4/6/7/8/9 workers)
# Usage: ./launch_head_ep_record.sh <gating_profile> <log_file> <record_dir> [mem_frac] [max_running_reqs] [cuda_graph_max_bs]
set -euo pipefail
