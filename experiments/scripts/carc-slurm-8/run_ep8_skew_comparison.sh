...
# Usage: bash run_ep8_skew_comparison.sh <head_host> <dist_init_addr> <worker1> <worker2> <worker3>
# Example: bash run_ep8_skew_comparison.sh b04-13 10.125.137.190:25000 b05-12 b05-14 b10-14
set -e
...
echo ""
echo "================================================================"
echo "ALL EP8 EXPERIMENTS COMPLETE"
echo "================================================================"
echo ""
