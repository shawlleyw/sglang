...
# Usage: bash run_ep16_skew_comparison.sh <dist_init_addr> <worker1_host> <worker2_host> <worker3_host>
# Example: bash run_ep16_skew_comparison.sh 10.0.0.11:25000 aisys-303-cluster02 aisys-303-cluster03 aisys-303-cluster07
set -e
