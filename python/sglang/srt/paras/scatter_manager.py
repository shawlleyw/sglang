...
def _scatter_cache_nccl(
    ...
    EP buffers are obtained directly from the memory manager for writing.
    After the loop, ``kv_cache.paras_configure_ep()`` switches all buffer
    pointers and rebuilds derived state.
